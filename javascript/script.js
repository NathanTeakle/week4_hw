...
endGame = () => {
    ...
    var playerName = prompt(`Cheers Heaps for Playing, here is your score:\nBonus Points for Correct Answers: ${score} + Bonus Points Lor Leftover Time: ${timeRemaining}\nTotal: ${finalScore}\n\nEnter a Name for the Scoreboard`);
